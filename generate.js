...
const TEMPLATES = [
  ...
  { id:'03', dir:'varsity-legacy', name:'Varsity Legacy', colors:{primary:'#1A1A2E',accent:'#8B0000','accent-light':'#DAA520',bg:'#F5F0E8','bg-alt':'#E8E8E8',text:'#2C2C2C'}, fonts:['"Bebas Neue"','"Roboto"','"Roboto Condensed"'], heroPattern:'stripes', accentRule:false },
  { id:'04', dir:'old-guard', name:'Old Guard', colors:{primary:'#2D2D2D',accent:'#B87333','accent-light':'#6B1D1D',bg:'#F4EDE4','bg-alt':'#3E2723',text:'#3E2723'}, fonts:['"Libre Baskerville"','"Nunito Sans"','"Inter"'], heroPattern:'crosshatch', accentRule:true },
  { id:'05', dir:'heritage-craft', name:'Heritage Craft', colors:{primary:'#1A535C',accent:'#D4A843','accent-light':'#C2B280',bg:'#FAF9F6','bg-alt':'#2B2B2B',text:'#2B2B2B'}, fonts:['"DM Serif Display"','"DM Sans"','"Inter"'], heroPattern:'waves', accentRule:false },
  { id:'06', dir:'tech-forge', name:'Tech Forge', colors:{primary:'#0D0D0D',accent:'#AAFF00','accent-light':'#1A1A1A',bg:'#E5E5E5','bg-alt':'#1A1A1A',text:'#1A1A1A'}, fonts:['"Space Grotesk"','"DM Sans"','"Space Mono"'], heroPattern:'circuit', accentRule:false },
  { id:'07', dir:'aero-sport', name:'Aero Sport', colors:{primary:'#1C1C1E',accent:'#0066FF','accent-light':'#E8F4FD',bg:'#F0F2F5','bg-alt':'#FFFFFF',text:'#1C1C1E'}, fonts:['"Outfit"','"Inter"','"JetBrains Mono"'], heroPattern:'airflow', accentRule:false },
  { id:'08', dir:'carbon', name:'Carbon', colors:{primary:'#1C1C1C',accent:'#E63946','accent-light':'#8D99AE',bg:'#FFFFFF','bg-alt':'#333333',text:'#333333'}, fonts:['"Rajdhani"','"Inter"','"Roboto Mono"'], heroPattern:'carbon', accentRule:false },
  { id:'09', dir:'kinetic', name:'Kinetic', colors:{primary:'#1A1A1A',accent:'#FF6B35','accent-light':'#C0C0C0',bg:'#FFFFFF','bg-alt':'#9E9E9E',text:'#1A1A1A'}, fonts:['"Rajdhani"','"Work Sans"','"Inter"'], heroPattern:'diagonal', accentRule:false },
  { id:'10', dir:'velocity', name:'Velocity', colors:{primary:'#190033',accent:'#00E5FF','accent-light':'#2D1B4E',bg:'#F5F5F5','bg-alt':'#2D1B4E',text:'#FFFFFF'}, fonts:['"Syne"','"Inter"','"JetBrains Mono"'], heroPattern:'speedlines', accentRule:false },
  { id:'11', dir:'steel-works', name:'Steel Works', colors:{primary:'#2C3539',accent:'#FFD700','accent-light':'#1A1A1A',bg:'#E0E0E0','bg-alt':'#1A1A1A',text:'#1A1A1A'}, fonts:['"Oswald"','"Source Sans 3"','"Inter"'], heroPattern:'hazard', accentRule:false },
  { id:'12', dir:'ironclad', name:'Ironclad', colors:{primary:'#1B1B1B',accent:'#B7410E','accent-light':'#4682B4',bg:'#F5F0E8','bg-alt':'#6B6B6B',text:'#1B1B1B'}, fonts:['"Barlow Condensed"','"Inter"','"Roboto Mono"'], heroPattern:'rivets', accentRule:false },
  { id:'13', dir:'factory-floor', name:'Factory Floor', colors:{primary:'#0F172A',accent:'#DC2626','accent-light':'#78716C',bg:'#F8FAFC','bg-alt':'#334155',text:'#334155'}, fonts:['"Barlow"','"Inter"','"JetBrains Mono"'], heroPattern:'grid', accentRule:false },
  { id:'14', dir:'powerhouse', name:'Powerhouse', colors:{primary:'#212529',accent:'#0D6EFD','accent-light':'#6C757D',bg:'#F8F9FA','bg-alt':'#FFFFFF',text:'#212529'}, fonts:['"Montserrat"','"Open Sans"','"Inter"'], heroPattern:'power', accentRule:false },
  ...
  { id:'22', dir:'power-play', name:'Power Play', colors:{primary:'#0A1F44',accent:'#C41E3A','accent-light':'#64748B',bg:'#FFFFFF','bg-alt':'#E8EEF6',text:'#0A1F44'}, fonts:['"Anton"','"Inter"','"Roboto Mono"'], heroPattern:'team', accentRule:false },
  { id:'23', dir:'endurance', name:'Endurance', colors:{primary:'#1C1917',accent:'#EA580C','accent-light':'#78716C',bg:'#FFFBEB','bg-alt':'#134E4A',text:'#1C1917'}, fonts:['"Sora"','"Inter"','"JetBrains Mono"'], heroPattern:'progress', accentRule:false },
  { id:'24', dir:'peak-form', name:'Peak Form', colors:{primary:'#18181B',accent:'#84CC16','accent-light':'#27272A',bg:'#F4F4F5','bg-alt':'#27272A',text:'#18181B'}, fonts:['"Outfit"','"Inter"','"JetBrains Mono"'], heroPattern:'mountain', accentRule:false },
  { id:'25', dir:'apex-predator', name:'Apex Predator', colors:{primary:'#0C0A09',accent:'#EAB308','accent-light':'#1C1917',bg:'#FEF9C3','bg-alt':'#0C0A09',text:'#1C1917'}, fonts:['"Playfair Display"','"Inter"','"JetBrains Mono"'], heroPattern:'goldline', accentRule:false },
  { id:'26', dir:'global-reach', name:'Global Reach', colors:{primary:'#2C3E50',accent:'#0047AB','accent-light':'#BDC3C7',bg:'#E6F0FF','bg-alt':'#FFFFFF',text:'#2C3E50'}, fonts:['"Poppins"','"Inter"','"JetBrains Mono"'], heroPattern:'globe', accentRule:false },
  { id:'27', dir:'export-elite', name:'Export Elite', colors:{primary:'#0F172A',accent:'#F59E0B','accent-light':'#1E293B',bg:'#F8FAFC','bg-alt':'#FFFFFF',text:'#0F172A'}, fonts:['"Plus Jakarta Sans"','"Inter"','"JetBrains Mono"'], heroPattern:'certs', accentRule:false },
  { id:'28', dir:'world-sport', name:'World Sport', colors:{primary:'#164E63',accent:'#0891B2','accent-light':'#F97316',bg:'#ECFEFF','bg-alt':'#FFFFFF',text:'#164E63'}, fonts:['"Nunito Sans"','"Inter"','"JetBrains Mono"'], heroPattern:'container', accentRule:false },
  { id:'29', dir:'cross-continental', name:'Cross Continental', colors:{primary:'#0F172A',accent:'#DC2626','accent-light':'#334155',bg:'#F1F5F9','bg-alt':'#E2E8F0',text:'#0F172A'}, fonts:['"Space Grotesk"','"Inter"','"JetBrains Mono"'], heroPattern:'timezone', accentRule:false },
  { id:'30', dir:'trade-titan', name:'Trade Titan', colors:{primary:'#111827',accent:'#2563EB','accent-light':'#374151',bg:'#F9FAFB','bg-alt':'#FFFFFF',text:'#111827'}, fonts:['"Montserrat"','"Inter"','"JetBrains Mono"'], heroPattern:'calculator', accentRule:false },
  { id:'31', dir:'disrupt-sport', name:'Disrupt Sport', colors:{primary:'#0A0A0A',accent:'#39FF14','accent-light':'#525252',bg:'#FFFFFF','bg-alt':'#0A0A0A',text:'#0A0A0A'}, fonts:['"Syne"','"Inter"','"Space Mono"'], heroPattern:'glow', accentRule:false },
  { id:'32', dir:'fresh-kit', name:'Fresh Kit', colors:{primary:'#2D3436',accent:'#FF6B6B','accent-light':'#636E72',bg:'#FFFFFF','bg-alt':'#FFF5F5',text:'#2D3436'}, fonts:['"Nunito"','"Inter"','"JetBrains Mono"'], heroPattern:'blobs-pink', accentRule:false },
  { id:'33', dir:'direct-sport', name:'Direct Sport', colors:{primary:'#111827',accent:'#F59E0B','accent-light':'#212529',bg:'#F8F9FA','bg-alt':'#FFFFFF',text:'#111827'}, fonts:['"Inter"','"Inter"','"JetBrains Mono"'], heroPattern:'amber-bars', accentRule:false },
  { id:'34', dir:'next-gen', name:'Next Gen', colors:{primary:'#0F0A1F',accent:'#7C3AED','accent-light':'#1E1B4B',bg:'#F5F3FF','bg-alt':'#FFFFFF',text:'#0F0A1F'}, fonts:['"Geist"','"Inter"','"JetBrains Mono"'], heroPattern:'mesh', accentRule:false },
  { id:'35', dir:'sport-lab', name:'Sport Lab', colors:{primary:'#1E293B',accent:'#2563EB','accent-light':'#64748B',bg:'#EFF6FF','bg-alt':'#FFFFFF',text:'#1E293B'}, fonts:['"Plus Jakarta Sans"','"Inter"','"JetBrains Mono"'], heroPattern:'lab-dots', accentRule:false },
  { id:'36', dir:'sportswear-post', name:'Sportswear Post', colors:{primary:'#1A1A1A',accent:'#8B0000','accent-light':'#6B6255',bg:'#FFF8E7','bg-alt':'#FAF0D7',text:'#1A1A1A'}, fonts:['"Lora"','"Inter"','"Roboto Mono"'], heroPattern:'newspaper', accentRule:false },
  { id:'37', dir:'athletic-standard', name:'Athletic Standard', colors:{primary:'#000000',accent:'#E53935','accent-light':'#9E9E9E',bg:'#FFFFFF','bg-alt':'#F5F5F5',text:'#000000'}, fonts:['"DM Serif Display"','"Inter"','"JetBrains Mono"'], heroPattern:'magazine', accentRule:false },
  { id:'38', dir:'pitch-report', name:'Pitch Report', colors:{primary:'#212121',accent:'#1A237E','accent-light':'#757575',bg:'#F5F5F0','bg-alt':'#E8EAF6',text:'#212121'}, fonts:['"Merriweather"','"Open Sans"','"Roboto Mono"'], heroPattern:'scorecard', accentRule:false },
  { id:'39', dir:'sideline-stories', name:'Sideline Stories', colors:{primary:'#3E2723',accent:'#2E7D32','accent-light':'#5D4037',bg:'#FAFAF5','bg-alt':'#F5F0E1',text:'#3E2723'}, fonts:['"Libre Baskerville"','"Nunito Sans"','"Inter"'], heroPattern:'filmstrip', accentRule:false },
  { id:'40', dir:'match-day', name:'Match Day', colors:{primary:'#212121',accent:'#FF6D00','accent-light':'#9E9E9E',bg:'#F5F5F5','bg-alt':'#FFFFFF',text:'#212121'}, fonts:['"Oswald"','"Roboto"','"Inter"'], heroPattern:'ticker', accentRule:false },
  { id:'41', dir:'night-game', name:'Night Game', colors:{primary:'#0A0A0A',accent:'#00BFFF','accent-light':'#404040',bg:'#FFFFFF','bg-alt':'#000000',text:'#FFFFFF'}, fonts:['"Rajdhani"','"Inter"','"JetBrains Mono"'], heroPattern:'floodlight', accentRule:false },
  { id:'42', dir:'shadow-play', name:'Shadow Play', colors:{primary:'#1A1A1A',accent:'#B71C1C','accent-light':'#424242',bg:'#E0E0E0','bg-alt':'#FFFFFF',text:'#1A1A1A'}, fonts:['"Bebas Neue"','"Inter"','"Roboto Mono"'], heroPattern:'spotlight', accentRule:false },
  { id:'43', dir:'midnight-kit', name:'Midnight Kit', colors:{primary:'#121212',accent:'#FFD700','accent-light':'#616161',bg:'#FFF8E1','bg-alt':'#1E1E1E',text:'#1E1E1E'}, fonts:['"Cormorant Garamond"','"Inter"','"JetBrains Mono"'], heroPattern:'gold-border', accentRule:false },
  { id:'44', dir:'arena', name:'Arena', colors:{primary:'#16213E',accent:'#00FF88','accent-light':'#1A1A2E',bg:'#F0F0F0','bg-alt':'#16213E',text:'#16213E'}, fonts:['"Outfit"','"Inter"','"JetBrains Mono"'], heroPattern:'field', accentRule:false },
  { id:'45', dir:'blackout', name:'Blackout', colors:{primary:'#000000',accent:'#737373','accent-light':'#E5E5E5',bg:'#F5F5F5','bg-alt':'#FFFFFF',text:'#000000'}, fonts:['"Inter Tight"','"Inter"','"JetBrains Mono"'], heroPattern:'geometry', accentRule:false },
  { id:'46', dir:'handcrafted-sport', name:'Handcrafted Sport', colors:{primary:'#3E2723',accent:'#8D6E63','accent-light':'#D7CCC8',bg:'#FFF8E1','bg-alt':'#FFFFFF',text:'#3E2723'}, fonts:['"Crimson Pro"','"Work Sans"','"Inter"'], heroPattern:'waves-brown', accentRule:false },
  { id:'47', dir:'stitch-thread', name:'Stitch & Thread', colors:{primary:'#292524',accent:'#C2452D','accent-light':'#78716C',bg:'#FAF9F6','bg-alt':'#F5F0EB',text:'#292524'}, fonts:['"DM Serif Display"','"DM Sans"','"Inter"'], heroPattern:'stitch', accentRule:false },
  { id:'48', dir:'material-world', name:'Material World', colors:{primary:'#111827',accent:'#3B82F6','accent-light':'#1E3A5F',bg:'#F3F4F6','bg-alt':'#FFFFFF',text:'#111827'}, fonts:['"Instrument Sans"','"Inter"','"JetBrains Mono"'], heroPattern:'weave', accentRule:false },
  { id:'49', dir:'quality-cut', name:'Quality Cut', colors:{primary:'#1C1917',accent:'#7F1D1D','accent-light':'#78716C',bg:'#FEF2F2','bg-alt':'#FFFFFF',text:'#1C1917'}, fonts:['"Fraunces"','"Inter"','"JetBrains Mono"'], heroPattern:'diagonal-cut', accentRule:false },
...
<div class="anim">
<p class="font-mono text-xs tracking-widest uppercase mb-4 opacity-60" style="color:${heroText}">Est. <span id="h-yr"></span> — Sialkot, Pakistan</p>
<h1 class="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6" style="color:${heroText}" id="h-tag"></h1>
<p class="text-lg leading-relaxed mb-8 max-w-lg opacity-70" style="color:${heroText}" id="h-desc"></p>
<div class="flex flex-wrap gap-4 mb-8">
<a href="#contact" class="px-8 py-3 font-semibold text-sm tracking-wide rounded" style="background:${accent};color:${primary}">Request a Quote</a>
...
<div class="flex flex-wrap gap-6 opacity-60" style="color:${heroText}" id="hero-trust"></div>
</div>
...
<p class="font-display text-3xl font-bold" style="color:${heroText}">APEX</p>
<p class="font-mono text-xs tracking-widest uppercase opacity-60" style="color:${heroText}">Sportswear Industries</p>
</div>
</div>
<div class="absolute -bottom-4 -left-4 px-6 py-3 rounded font-mono text-sm font-bold" style="background:${accent};color:${primary}">
...
<section class="py-12" style="background:${primary}">
...
<h3 class="font-display text-xl font-bold mb-6" style="color:${heroText}">Contact Us Directly</h3>
<div class="space-y-6" id="c-contact-cards"></div>
<div class="mt-8 p-4 rounded-lg" style="background:${accent}11;border:1px solid ${accent}22">
<p class="text-xs opacity-60 mb-2" style="color:${heroText}">Prefer to email?</p>
<a href="mailto:info@apexsportswear.com" class="text-sm font-semibold" style="color:${accent}">info@apexsportswear.com</a>
</div>
</div>
</div>
</section>
...
const c=d.company,cap=d.capabilities,exp=d.exportInfo;
  ...
  document.querySelector('#c-contact-cards').innerHTML=[
    {icon:'📞',label:'Phone',val:d.contact.phone,href:'tel:'+d.contact.phone.replace(/\s+/g,'')},
    {icon:'💬',label:'WhatsApp',val:d.contact.whatsapp,href:'https://wa.me/'+d.contact.whatsapp.replace(/[^0-9]/g,'')},
